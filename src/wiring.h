...
const PinName motor_right_in1_pin = D1;
const PinName motor_right_in2_pin = D0;
const PinName unused_D2 = D2;
const PinName motor_left_in1_pin = D3;
const PinName serial_rx_pin = D4;
const PinName serial_tx_pin = D5;
const PinName motor_left_in2_pin = D6;
const PinName motor_left_en_pin = D7;
const PinName motor_right_en_pin = D8;
