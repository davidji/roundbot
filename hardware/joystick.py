...
40 degrees in any direction. The know on the top is 20mm wide
so the hole it in the panel must be at least that wide.
"""
...
def block():
    ...
    return (forward(1.8)(linear_extrude(height)(square([35,35], center=True))) -
            up(pivot_height)(sphere(r=14.0)) -
            down(ABIT)(cylinder(h=pivot_height+ABIT, r=14.0)) -
            up(pivot_height)(cylinder(r1=6.0, r2=6.0 + tan(radians(30.0))*panel_height, h=panel_height)) -
