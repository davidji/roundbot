...
def usb_box_shoe():
    ...
    return (
        up(6.6)(forward((wall_thickness + usb.breakout.d[1])/2)(
...
def usb_box_top():
    id = [width, depth, 11]
    return (forward((wall_thickness + usb.breakout.d[1])/2) (
